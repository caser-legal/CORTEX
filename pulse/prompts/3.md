...
2. Verify the app's UI EXACTLY matches ~/Documents/iOS/dev-docs/MASTER.md
...
python3 ~/.codex/scripts/ui_audit.py .
...
Begin by reading the ~/Documents/iOS/dev-docs/MASTER.md!
