...
**YOUR MISSION:** Verify the app's UI EXACTLY matches ~/Documents/iOS/dev-docs/MASTER.md and fix any violations.
...
- **MANDATORY**: Read COMPLETE ~/Documents/iOS/dev-docs/MASTER.md and ALL relevant Swift files before auditing
...
- **Ask**: "What if that pattern VIOLATES Apple HIG or ~/Documents/iOS/dev-docs/MASTER.md?"
...
- **Standards**: ~/Documents/iOS/dev-docs/MASTER.md, Apple HIG, ui_preflight.py, app-reject-checklist.md
...
**Full protocol details: `~/Documents/iOS/dev-docs/CASCADE-PREVENTION.md`**
...
- ✅ Check code against ~/Documents/iOS/dev-docs/MASTER.md
...
- ✅ Read ~/Documents/iOS/dev-docs/MASTER.md to understand the design spec
...
- ✅ Read and understand ~/Documents/iOS/dev-docs/MASTER.md
...
- UI matches ~/Documents/iOS/dev-docs/MASTER.md more closely after session
...
**Your mission:** Make the app's UI EXACTLY match ~/Documents/iOS/dev-docs/MASTER.md.

Every pixel matters. Every spacing matters. Every color matters.

Research thoroughly. Fix precisely. Verify completely.

Begin by reading the ~/Documents/iOS/dev-docs/MASTER.md!  DONT FORGET TO CLEAN, BUILD, AND INSTALL ON DEVICE WHEN DONE WITH EACH SESSION! 
