...
**Reference docs:** /Users/home/Documents/iOS/dev-docs
...
### Full checklist: `/Users/home/Desktop/SUBSCRIPTION_CHECKLIST.txt`
...
✅ GOOD: 
  ...
  2. perplexity_search "NavigationStack best practices" ← MANDATORY for build errors/new features
  3. getlibrarydocs (Context7) for API reference
  4. Compare all results for consistency before concluding
```

**🔴 MANDATORY: Use perplexity_search for:**
- Build errors (it knows the fix instantly)
- New feature implementation ideas
- When research_topic doesn't give enough context

**⚠️ WHY perplexity is MANDATORY:** `research_topic` and `extract_webpage_content` use basic HTTP fetch which CANNOT read JavaScript-rendered sites (Apple docs, kiro.dev, most modern documentation). `perplexity_search` renders JavaScript internally and can actually read modern docs - don't waste time wondering why extraction returned empty content!
...
**Thorough =**
- 3–5 specific searches
- Use extract_webpage_content/read full docs
...
Use:
- research_topic FIRST (free, search + extraction in one call)
- perplexity_search for build errors and new feature ideas (MANDATORY)
...
Refer to `/Users/home/Documents/iOS/dev-docs/guides/design-system.md`
...
python3 ~/.codex/scripts/ui_preflight.py .

# 2. If ANY critical issues, run autofix (adds TODO comments for risky fixes)
python3 ~/.codex/scripts/ui_autofix.py .
...
- Use `/Users/home/Documents/iOS/asc` for all Store automation.
