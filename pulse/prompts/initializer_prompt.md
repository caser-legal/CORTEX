...
Start by reading `~/Documents/iOS/dev-docs/MASTER.md` in your working directory. This file contains
...
**All apps MUST replicate the professional UI from `~/Documents/iOS/dev-docs/MASTER.md`**
...
Based on `~/Documents/iOS/dev-docs/MASTER.md` and the design system above, create `feature_list.json` with 200+ detailed test cases.
...
- Cover ALL features from ~/Documents/iOS/dev-docs/MASTER.md
...
sed -i '' 's/DEVELOPMENT_TEAM = YOUR_TEAM_ID;/DEVELOPMENT_TEAM = YOUR_TEAM_ID;\
				INFOPLIST_KEY_CFBundleDisplayName = "Steppr";\
				INFOPLIST_KEY_LSApplicationCategoryType = "public.app-category.healthcare-fitness";\
				INFOPLIST_KEY_NSHumanReadableCopyright = "© 2025 Your Name - All Rights Reserved.";/g' *.xcodeproj/project.pbxproj
