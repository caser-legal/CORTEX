...
2. **Upload the App:**
   ...
   ```
   - Runs build, archive, IPA export, TestFlight and metadata upload, subscription creation, and adds user@example.com as tester.
...
2. Copyright: "© 2025 Your Name - All Rights Reserved."
...
For each app:
```bash
cd ~/Documents/iOS && ./asc upload [AppName]
```
...
Reference: `~/Documents/iOS/dev-docs/app-store-connect/README.md`
...
```bash
cd ~/Documents/iOS && python3 dev-docs/scripts/update-submissions.py
```
