 ...
 * command = "npx"
 * args = ["tsx", (process.env.HOME || "") + "/Documents/nvidia-cli/mcp-server.ts"]
 * cwd = (process.env.HOME || "") + "/Documents/nvidia-cli"
 */
...
const apiKey = process.env.NVIDIA_API_KEY || process.env.NGC_API_KEY || process.env.NVIDIA_API_KEY || "";
