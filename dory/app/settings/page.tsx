...
const TOOLS = [
  // ============ PROJECT (2) ============
  {
    ...
    example: 'set_project({ path: (process.env.HOME || "") + "/Documents/MyApp" })',
  },
  {
    name: "get_project", 
    path: "lib/agents/tools/project.ts",
...
export default function SettingsPage() {
  ...
  const [ollamaUrl, setOllamaUrl] = React.useState("http://127.0.0.1:11434/v1");
  const [embedUrl, setEmbedUrl] = React.useState("http://127.0.0.1:8000");
