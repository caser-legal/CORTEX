...
const AGENTS_BASE_PATH = process.env.NVIDIA_AGENTS_PATH || (process.env.HOME || "") + "/Desktop/nvidia-quickstarts-main";
  ...
  if (action === "start") {
    ...
    try {
      const proc = spawn(command, args, {
        ...
        env: {
          ...process.env,
          NVIDIA_API_KEY: process.env.NVIDIA_API_KEY || process.env.NVIDIA_API_KEY || "",
