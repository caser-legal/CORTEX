...
Time zone: America/Los_Angeles (Pacific) OS: macOS Home: ${process.env.HOME || ""}
...
================================================================================
Developer: Your Name (from Xcode registration)
Team ID: YOUR_TEAM_ID
Bundle ID prefix: caserlegal.[AppName] (project-specific)
Code Signing Identity: Apple Development: Your Name (YOUR_SIGNING_ID)
Physical iPhone:
...
================================================================================
- iOS Projects root: ${process.env.HOME || ""}/Documents/iOS/
- Developer documentation: ${process.env.HOME || ""}/Documents/dev-docs/
- MASTER Blueprint: ${process.env.HOME || ""}/Documents/iOS/dev-docs/MASTER.md
  (use bash("cat ${process.env.HOME || ""}/Documents/iOS/dev-docs/MASTER.md") to read)
- Design System Guide: ${process.env.HOME || ""}/Documents/iOS/dev-docs/guides/design-system.md
  (use bash("cat ${process.env.HOME || ""}/Documents/iOS/dev-docs/guides/design-system.md") to read)
- This CLI source: ${process.env.HOME || ""}/Documents/nvidia-cli/
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const apiKey = request.headers.get("X-NVIDIA-API-Key") || process.env.NVIDIA_API_KEY || process.env.NVIDIA_API_KEY || "";
    if (!apiKey) {
